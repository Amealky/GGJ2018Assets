...
public class HUDScript : MonoBehaviour {
	...
	void updateBonusUI(){
		if(GameObject.Find("Joueur1") != null){
			...
			Player1TimeBeforeGetFucked.GetComponent<UnityEngine.UI.Text>().text = Script1.getModel().timeLeftBeforeGetFucked+""; 
		}
		if(GameObject.Find("Joueur2") != null){
			PersonnageController Script2 = GameObject.Find("Joueur2").GetComponent<PersonnageController>();
			Player2HasBonus.active = Script2.getModel().hasBonus;
			Player2TimeBeforeGetFucked.GetComponent<UnityEngine.UI.Text>().text = Script2.getModel().timeLeftBeforeGetFucked+""; 
		}
	}
